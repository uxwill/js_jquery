...
function mathFunction(){
 ...
 var cb = Math.pow( 5 , 3 ) ; // 5 to the power 3 (5x5x5).
 demo2.innerHTML = "5 to the power of 2 = " + sq;
 demo2.innerHTML += "<br>5 to the power of 3 = " + cb;
 demo2.innerHTML += "<br><br>Largest Positive: " + Math.max( sq , cb ) ;
